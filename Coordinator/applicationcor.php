                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modalTitle">Review Application</h5>
                        ...
                        <div class="modal-body">
                            <form id="winForm">
                                <div class="form-row">  
                                    ...
                                    <div class="col-md-6"> 
                                        <div class="form-group">
                                            <label for="decision2">Decision</label>
                                            <select name= "decision2" id= "decision2" class="form-control" required >
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="coordinator">Comments</label>
                                        <input type="textarea" class="form-control" id="coordinator" name="coordinator" >
                                    </div>
                                                ...
                                                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>To</th>
                                                            <th>Company</th>
                                                           <!-- <th onclick="sort(this)">Status</th> -->
                                                            <th>Status</th>
                                                            <th>Coordinator</th>
                                                            <th>Actions</th>
                                                        </tr>
...
<script>
    ...
    <script>
        ...
        function editBtn(id, offer_id, date, description, fromdate, todate, company, decision2, coordinator, notes) {
            $('#id').val(id);
