                            ...
                            <form id="winForm">
                                <div class="form-row">  
                                    ...
                                    <div class="form-group col-md-10">
                                        ...
                                        <input type="date" class="form-control" id="student" name="student" required>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                                    ...
                                                    <input type="radio" name="decision" value="A" <?php echo ($insuranceform['decision'] == 'M') ? 'checked' : ''; ?>> Accepted 
                                                    <input type="radio" name="decision" value="R" <?php echo ($insuranceform['decision'] == 'F') ? 'checked' : ''; ?>> Rejected
                                            </div>
                                    </div>
                                    <div class="form-group col-md-5">
