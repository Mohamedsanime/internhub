...
<html>
<head>
    <title>Internship Tasks Data Management</title>
    ...
    <div class="content-wrapper">
            ...
            <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0"><b>Internship Tasks Data Management</b></h1>
                            </div><!-- /.col -->
                             <div class="col-sm-6">
                        ...
                        <div class="modal-body">
                            <form id="winForm">
                                <div class="form-row">  
                                    ...
                                    <div class="form-group col-md-10">
                                        <label for="accomplishmenmt">Accomplishment</label>
                                        <input type="text" class="form-control" id="accomplishment" name="accomplishment" required>
                                    </div>
                                    <div class="form-group col-md-10">
