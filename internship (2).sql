...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 29, 2023 at 04:26 PM
...
INSERT INTO `application` (`id`, `appdate`, `description`, `decision`, `decisiondate`, `notes`, `student_id`, `offer_id`) VALUES
(2, '2023-11-01', 'Application 01', 'P', '2023-11-01', NULL, 1, 1);
...
(1, 'Alpha', 'Alpha Data', 'Faizoor', 'Sales Supervisor', 'Faizoor@alpha.ae', 'alpha.ae', '+97121234567', '12345678', 'Abu Dhabi'),
(8, 'amf', 'Arab Monetary Fund', 'Abdelwahab AMIRA', 'Position1', 'yawahab@gmail.com', 'https://www.google.com', '12345678', '123456789', 'Ap 2102, Block A, Golden Beach Tower');
...
(1, 1, '12345678', 'Doctor', '1', NULL, NULL, 'Address 01', 'Any notes', 43);
...
(1, 'Internship Offer 01', '2023-11-01', '2024-06-30', 'Abu Dhabi', 'Testing', '2023-12-31', 5, 0, NULL, 1);
...
(1, '1', 'M', '0501234567', 'Testing', 1, '2023-10-01', NULL, 'Abu Dhabi', 1, 788);
...
(1, 1, '012345678', 'Qualification 01', 'Notes AAAAAAAA', 44, 1, '2023-12-04', '0000-00-00', 'Address 01', 1),
(2, 1, '012345678', 'Qualification 01', 'Notes AAAAAAAA', 44, 1, '2023-12-04', '0000-00-00', 'Address 01', 1);
...
(1, 'Amira', 'Mohamed', '123456@emu.edu.tr', 'a1bc758c58c1868bd71f3f2971a7e501', 1),
(43, 'Ali', 'Ahmad', '123654@emu.edu.tr', '4e6fec3630db86b46933bfef7b8f8d48', 2),
(44, 'Personel', 'Test', 'personel@emu.edu.tr', '24d5cf4a7c1c01020a4131757f1406f7', 3),
(45, 'Amira', 'Sirine', '200929029@emu.edu.tr', '475669a24cedc37ff25aedf47397aa7c', 4),
...
ALTER TABLE `feedback`
  ADD PRIMARY KEY (`id`),
  ADD KEY `feedback_intr_fk01` (`internship_id`);
...
--
ALTER TABLE `feedback`
  ADD CONSTRAINT `feedback_intr_fk01` FOREIGN KEY (`internship_id`) REFERENCES `internship` (`id`);
