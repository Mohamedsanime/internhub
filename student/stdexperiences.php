...
<html>
<head>
    <title>Student Experience Data Management</title>
...
<body>
    <div class="content-wrapper">
            ...
            <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0"><b>Student Experiences Data Management</b></h1>
                            </div><!-- /.col -->
                             <div class="col-sm-6">
    ...
    <script>
        ...
        function editBtn(id, description, fromdate, todate, notes) {
            $('#id').val(id);
