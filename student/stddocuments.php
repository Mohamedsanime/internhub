...
<html>
<head>
    <title>Student Documents Data Management</title>
...
<body>
    <div class="content-wrapper">
            ...
            <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0"><b>Student Documents Data Management</b></h1>
                            </div><!-- /.col -->
                             <div class="col-sm-6">
                            ...
                            <form id="winForm">
                                <div class="form-row">  
                                    ...
                                    <div class="form-group col-md-5">
                                        <label for="uploadon">Uploaded On</label>
                                        <input type="date" class="form-control" id="uploadon" name="uploadon" required>
                                    </div>
    ...
    <script>
        ...
        function editBtn(id, title, uploadon, notes) {
            $('#id').val(id);
            $('#title').val(title);
            $('#uploadon').val(uploadon);
            $('#notes').val(notes);
            $('#action').val('Edit');
